...
U19interp,V19interp = augMatrice(U19,X20[0],Y20[:,0],X19[0],Y19[:,0]),augMatrice(V19,X20[0],Y20[:,0],X20[0],Y20[:,0])
print("19")
...
U18interp,V18interp = augMatrice(U18,X19[0],Y19[:,0],X18[0],Y18[:,0]),augMatrice(V18,X19[0],Y19[:,0],X19[0],Y19[:,0])
print("18")
...
U17interp,V17interp = augMatrice(U17,X18[0],Y18[:,0],X17[0],Y17[:,0]),augMatrice(V17,X18[0],Y18[:,0],X18[0],Y18[:,0])
print("17")
...
U16interp,V16interp = augMatrice(U16,X17[0],Y17[:,0],X16[0],Y16[:,0]),augMatrice(V16,X17[0],Y17[:,0],X17[0],Y17[:,0])
print("16")
...
U15interp,V15interp = augMatrice(U15,X16[0],Y16[:,0],X15[0],Y15[:,0]),augMatrice(V15,X16[0],Y16[:,0],X16[0],Y16[:,0])
print("15")
...
U14interp,V14interp = augMatrice(U14,X15[0],Y15[:,0],X14[0],Y14[:,0]),augMatrice(V14,X15[0],Y15[:,0],X15[0],Y15[:,0])
print("14")
...
U13interp,V13interp = augMatrice(U13,X14[0],Y14[:,0],X13[0],Y13[:,0]),augMatrice(V13,X14[0],Y14[:,0],X14[0],Y14[:,0])
print("13")
...
U12interp,V12interp = augMatrice(U12,X13[0],Y13[:,0],X12[0],Y12[:,0]),augMatrice(V12,X13[0],Y13[:,0],X13[0],Y13[:,0])
print("12")
...
U11interp,V11interp = augMatrice(U11,X12[0],Y12[:,0],X11[0],Y11[:,0]),augMatrice(V11,X12[0],Y12[:,0],X12[0],Y12[:,0])
print("11")
...
U10interp,V10interp = augMatrice(U10,X11[0],Y11[:,0],X10[0],Y10[:,0]),augMatrice(V10,X11[0],Y11[:,0],X11[0],Y11[:,0])
print("10")
...
U9interp,V9interp = augMatrice(U9,X10[0],Y10[:,0],X9[0],Y9[:,0]),augMatrice(V9,X10[0],Y10[:,0],X10[0],Y10[:,0])
print("9")
...
U8interp,V8interp = augMatrice(U8,X9[0],Y9[:,0],X8[0],Y8[:,0]),augMatrice(V8,X9[0],Y9[:,0],X9[0],Y9[:,0])
print("8")
...
U7interp,V7interp = augMatrice(U7,X8[0],Y8[:,0],X7[0],Y7[:,0]),augMatrice(V7,X8[0],Y8[:,0],X8[0],Y8[:,0])
print("7")
...
U6interp,V6interp = augMatrice(U6,X7[0],Y7[:,0],X6[0],Y6[:,0]),augMatrice(V6,X7[0],Y7[:,0],X7[0],Y7[:,0])
print("6")
...
U5interp,V5interp = augMatrice(U5,X6[0],Y6[:,0],X5[0],Y5[:,0]),augMatrice(V5,X6[0],Y6[:,0],X6[0],Y6[:,0])
print("5")
...
U4interp,V4interp = augMatrice(U4,X5[0],Y5[:,0],X4[0],Y4[:,0]),augMatrice(V4,X5[0],Y5[:,0],X5[0],Y5[:,0])
print("4")
...
U3interp,V3interp = augMatrice(U3,X4[0],Y4[:,0],X3[0],Y3[:,0]),augMatrice(V3,X4[0],Y4[:,0],X4[0],Y4[:,0])
print("3")
...
U2interp,V2interp = augMatrice(U2,X3[0],Y3[:,0],X2[0],Y2[:,0]),augMatrice(V2,X3[0],Y3[:,0],X3[0],Y3[:,0])
print("2")
...
U1interp,V1interp = augMatrice(U1,X2[0],Y2[:,0],X1[0],Y1[:,0]),augMatrice(V1,X2[0],Y2[:,0],X2[0],Y2[:,0])
print("1")
...
plt.xlabel('x')
plt.ylabel('y')
#plt.savefig('maillage4_V2.eps', format='eps')
plt.show()
