...
def CalculPosition(X,Y,U,V,dt,Flag):
...
Flag = np.ones_like(U20)

X19,Y19=CalculPosition(X20,Y20,U20,V20,dt,Flag)
...
U19interp,V19interp = interpolation(U19,X20[0],Y20[:,0],X20,Y20),interpolation(V19,X20[0],Y20[:,0],X20,Y20)
print("19")
X18,Y18=CalculPosition(X19,Y19,U19interp,V19interp,dt,Flag)
...
U18interp,V18interp = interpolation(U18,X19[0],Y19[:,0],X20,Y20),interpolation(V18,X19[0],Y19[:,0],X20,Y20)
print("18")
X17,Y17=CalculPosition(X18,Y18,U18interp,V18interp,dt,Flag)
...
U17interp,V17interp = interpolation(U17,X18[0],Y18[:,0],X20,Y20),interpolation(V17,X18[0],Y18[:,0],X20,Y20)
print("17")
X16,Y16=CalculPosition(X17,Y17,U17interp,V17interp,dt,Flag)
...
U16interp,V16interp = interpolation(U16,X17[0],Y17[:,0],X20,Y20),interpolation(V16,X17[0],Y17[:,0],X20,Y20)
print("16")
X15,Y15=CalculPosition(X16,Y16,U16interp,V16interp,dt,Flag)
...
U15interp,V15interp = interpolation(U15,X16[0],Y16[:,0],X20,Y20),interpolation(V15,X16[0],Y16[:,0],X20,Y20)
print("15")
X14,Y14=CalculPosition(X15,Y15,U15interp,V15interp,dt,Flag)
...
U14interp,V14interp = interpolation(U14,X15[0],Y15[:,0],X20,Y20),interpolation(V14,X15[0],Y15[:,0],X20,Y20)
print("14")
X13,Y13=CalculPosition(X14,Y14,U14interp,V14interp,dt,Flag)
...
U13interp,V13interp = interpolation(U13,X14[0],Y14[:,0],X20,Y20),interpolation(V13,X14[0],Y14[:,0],X20,Y20)
print("13")
X12,Y12=CalculPosition(X13,Y13,U13interp,V13interp,dt,Flag)
...
U12interp,V12interp = interpolation(U12,X13[0],Y13[:,0],X20,Y20),interpolation(V12,X13[0],Y13[:,0],X20,Y20)
print("12")
X11,Y11=CalculPosition(X12,Y12,U12interp,V12interp,dt,Flag)
...
U11interp,V11interp = interpolation(U11,X12[0],Y12[:,0],X20,Y20),interpolation(V11,X12[0],Y12[:,0],X20,Y20)
print("11")
X10,Y10=CalculPosition(X11,Y11,U11interp,V11interp,dt,Flag)
...
U10interp,V10interp = interpolation(U10,X11[0],Y11[:,0],X20,Y20),interpolation(V10,X11[0],Y11[:,0],X20,Y20)
print("10")
X9,Y9=CalculPosition(X10,Y10,U10interp,V10interp,dt,Flag)
...
U9interp,V9interp = interpolation(U9,X10[0],Y10[:,0],X20,Y20),interpolation(V9,X10[0],Y10[:,0],X20,Y20)

X8,Y8=CalculPosition(X9,Y9,U9interp,V9interp,dt,Flag)
...
U8interp,V8interp = interpolation(U8,X9[0],Y9[:,0],X20,Y20),interpolation(V8,X9[0],Y9[:,0],X20,Y20)

X7,Y7=CalculPosition(X8,Y8,U8interp,V8interp,dt,Flag)
...
U7interp,V7interp = interpolation(U7,X8[0],Y8[:,0],X20,Y20),interpolation(V7,X8[0],Y8[:,0],X20,Y20)

X6,Y6=CalculPosition(X7,Y7,U7interp,V7interp,dt,Flag)
...
U6interp,V6interp = interpolation(U6,X7[0],Y7[:,0],X20,Y20),interpolation(V6,X7[0],Y7[:,0],X20,Y20)

X5,Y5=CalculPosition(X6,Y6,U6interp,V6interp,dt,Flag)
...
U5interp,V5interp = interpolation(U5,X6[0],Y6[:,0],X20,Y20),interpolation(V5,X6[0],Y6[:,0],X20,Y20)

X4,Y4=CalculPosition(X5,Y5,U5interp,V5interp,dt,Flag)
...
U4interp,V4interp = interpolation(U4,X5[0],Y5[:,0],X20,Y20),interpolation(V4,X5[0],Y5[:,0],X20,Y20)
print("4")
X3,Y3=CalculPosition(X4,Y4,U4interp,V4interp,dt,Flag)
...
U3interp,V3interp = interpolation(U3,X4[0],Y4[:,0],X20,Y20),interpolation(V3,X4[0],Y4[:,0],X20,Y20)

X2,Y2=CalculPosition(X3,Y3,U3interp,V3interp,dt,Flag)
...
U2interp,V2interp = interpolation(U2,X3[0],Y3[:,0],X20,Y20),interpolation(V2,X3[0],Y3[:,0],X20,Y20)

X1,Y1=CalculPosition(X2,Y2,U2interp,V2interp,dt,Flag)
...
U1interp,V1interp = interpolation(U1,X2[0],Y2[:,0],X20,Y20),interpolation(V1,X2[0],Y2[:,0],X20,Y20)
print("1")
