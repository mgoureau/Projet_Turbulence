...
U18interp,V18interp = interpolation(U18,X19[0],Y19[:,0],X18,Y18),interpolation(V18,X19[0],Y19[:,0],X19,Y19)
print("18")
...
U17interp,V17interp = interpolation(U17,X18[0],Y18[:,0],X17,Y17),interpolation(V17,X18[0],Y18[:,0],X18,Y18)
print("17")
...
U16interp,V16interp = interpolation(U16,X17[0],Y17[:,0],X16,Y16),interpolation(V16,X17[0],Y17[:,0],X17,Y17)
print("16")
...
U15interp,V15interp = interpolation(U15,X16[0],Y16[:,0],X15,Y15),interpolation(V15,X16[0],Y16[:,0],X16,Y16)
print("15")
...
U14interp,V14interp = interpolation(U14,X15[0],Y15[:,0],X14,Y14),interpolation(V14,X15[0],Y15[:,0],X15,Y15)
print("14")
...
U13interp,V13interp = interpolation(U13,X14[0],Y14[:,0],X13,Y13),interpolation(V13,X14[0],Y14[:,0],X14,Y14)
print("13")
...
U12interp,V12interp = interpolation(U12,X13[0],Y13[:,0],X12,Y12),interpolation(V12,X13[0],Y13[:,0],X13,Y13)
print("12")
...
U11interp,V11interp = interpolation(U11,X12[0],Y12[:,0],X11,Y11),interpolation(V11,X12[0],Y12[:,0],X12,Y12)
print("11")
...
U10interp,V10interp = interpolation(U10,X11[0],Y11[:,0],X10,Y10),interpolation(V10,X11[0],Y11[:,0],X11,Y11)
print("10")
...
U9interp,V9interp = interpolation(U9,X10[0],Y10[:,0],X9,Y9),interpolation(V9,X10[0],Y10[:,0],X10,Y10)
print("9")
...
U8interp,V8interp = interpolation(U8,X9[0],Y9[:,0],X8,Y8),interpolation(V8,X9[0],Y9[:,0],X9,Y9)
print("8")
...
U7interp,V7interp = interpolation(U7,X8[0],Y8[:,0],X7,Y7),interpolation(V7,X8[0],Y8[:,0],X8,Y8)
print("7")
...
U6interp,V6interp = interpolation(U6,X7[0],Y7[:,0],X6,Y6),interpolation(V6,X7[0],Y7[:,0],X7,Y7)
print("6")
...
U5interp,V5interp = interpolation(U5,X6[0],Y6[:,0],X5,Y5),interpolation(V5,X6[0],Y6[:,0],X6,Y6)
print("5")
...
U4interp,V4interp = interpolation(U4,X5[0],Y5[:,0],X4,Y4),interpolation(V4,X5[0],Y5[:,0],X5,Y5)
print("4")
...
U3interp,V3interp = interpolation(U3,X4[0],Y4[:,0],X3,Y3),interpolation(V3,X4[0],Y4[:,0],X4,Y4)
print("3")
...
U2interp,V2interp = interpolation(U2,X3[0],Y3[:,0],X2,Y2),interpolation(V2,X3[0],Y3[:,0],X3,Y3)
print("2")
...
U1interp,V1interp = interpolation(U1,X2[0],Y2[:,0],X1,Y1),interpolation(V1,X2[0],Y2[:,0],X2,Y2)
print("1")
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig('maillage8_V2.eps', format='eps')
plt.show()
